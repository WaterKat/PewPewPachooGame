...
namespace WaterKatLLC.Ships
{
    public class ShipRotation : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (UnityEngine.Input.mousePosition != lastMouseInput)
            {
            ...
            switch (currentInput)
            {
                case InputToggle.Mouse:
                    Vector3 relativeMousePosition = Camera.main.ScreenToWorldPoint(UnityEngine.Input.mousePosition) - transform.position;
            ...
            lastMouseInput = UnityEngine.Input.mousePosition;
        }
    }
}